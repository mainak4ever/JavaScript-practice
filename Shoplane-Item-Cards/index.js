...
function createItemCard(id, preview, name, brand, price){
    ...
    var cardRef = document.createElement("a");
    cardRef.href= "#" + id;
...
//console.log(productList[0].preview)
getCardsData();